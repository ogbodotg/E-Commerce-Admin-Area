...
class ApprovedDeliveryAgent extends StatefulWidget {
  @override
  _ApprovedDeliveryAgentState createState() => _ApprovedDeliveryAgentState();
}

class _ApprovedDeliveryAgentState extends State<ApprovedDeliveryAgent> {
  bool status = false;
    ...
    return Container(
      child: StreamBuilder(
        ...
        builder: (context, snapshot) {
          ...
          if (snap.size == 0) {
            return Center(
              child: Text('No approved delivery agent to display'),
            );
          }
